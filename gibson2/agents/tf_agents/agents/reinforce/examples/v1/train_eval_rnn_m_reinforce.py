...
from gibson2.data_utils import *
...
from tf_agents.networks import actor_distribution_rnn_m_network
...
flags.DEFINE_integer('collect_episodes_per_iteration', 64,
...
flags.DEFINE_float('learning_rate', 3e-4,
                   'Actor learning rate')
flags.DEFINE_float('AMR_regularizer', 0,
                    'AMR regularizer (group lasso)')
...
flags.DEFINE_integer('actor_rnn_size', 64,
                     'actor rnn size')
...
@gin.configurable
def train_eval_rnn_m_reinforce(
        root_dir,
        gpu=0,
        env_load_fn=None,
        model_ids=None,
    ...
    with tf.compat.v2.summary.record_if(
        ...
        actor_net = actor_distribution_rnn_m_network.ActorDistributionRnnNetwork(
            observation_spec,
            action_spec,
            preprocessing_layers=preprocessing_layers,
            preprocessing_combiner=preprocessing_combiner,
            input_fc_layer_params=actor_fc_layers,
            rnn_size=actor_rnn_size,
            output_fc_layer_params=actor_output_fc_layers,
            continuous_projection_net=normal_projection_net,
            kernel_initializer=glorot_uniform_initializer,
        )

        # Variable holder, not actual implementation
        ...
        train_op = tf_agent.train(experience, lam=lam)
        ...
        with sess.as_default():
            ...
            print('global step val: ', global_step_val)
...
def main(_):
    ...
    train_eval_rnn_m_reinforce(
        ...
        env_load_fn=lambda model_id, mode, device_idx: suite_gibson.load(
            ...
            random_height=False,
            random_init_m=FLAGS.random_init_m,
            seed=FLAGS.seed
        ),
        ...
        actor_rnn_size=[FLAGS.actor_rnn_size],
        num_parallel_environments=FLAGS.num_parallel_environments,
        collect_episodes_per_iteration=FLAGS.collect_episodes_per_iteration,
        replay_buffer_capacity=FLAGS.replay_buffer_capacity,
        learning_rate=FLAGS.learning_rate,
        lam=FLAGS.AMR_regularizer,
        gamma=FLAGS.gamma,
