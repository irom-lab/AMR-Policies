...
from tf_agents.networks import rnn_encoding_network
...
class ActorDistributionRnnNetwork(network.DistributionNetwork):
  ...
  def __init__(self,
    ...
    rnn_encoder = rnn_encoding_network.RNNEncodingNetwork(
    ...
    super(ActorDistributionRnnNetwork, self).__init__(
        input_tensor_spec=input_tensor_spec,
        state_spec=rnn_encoder.state_spec,
  ...
  def call(self, observation, step_type, network_state=None):
    state, network_state = self._rnn_encoder(
